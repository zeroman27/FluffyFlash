...
#
# Usage:
#   ./WinMist/Scripts/bench_wimsplit.sh /path/to/install.wim /path/to/dest_dir [part_size_mb]
#
# Example (split to USB volume):
#   ./WinMist/Scripts/bench_wimsplit.sh "/Volumes/CCCOMA_X64FRE_EN-US_DV9/sources/install.wim" "/Volumes/WINSETUP/sources" 4000
#
# Notes:
