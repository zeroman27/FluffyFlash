...
enum WistTheme {
    ...
    /// Extra mid-stop keeps the column from reading flat; cool edge hints “aurora” depth.
    static var sidebarGradient: LinearGradient {
        LinearGradient(
            colors: [
                Color(red: 0.16, green: 0.09, blue: 0.26),
                Color(red: 0.12, green: 0.07, blue: 0.20),
                Color(red: 0.07, green: 0.045, blue: 0.13),
                Color(red: 0.04, green: 0.028, blue: 0.075),
            ],
    ...
    /// Cool rim accent for icons / highlights on dark chrome (pairs with violet mist).
    static var auroraCyan: Color {
        Color(red: 0.42, green: 0.82, blue: 0.94)
    }
...
enum WistFont {
    ...
    /// Titles and hero numbers — SF Rounded for a softer, modern read.
    static func displayRounded(_ size: CGFloat = 26) -> Font {
    ...
    static func titleRounded(_ size: CGFloat = 17) -> Font {
        .system(size: size, weight: .semibold, design: .rounded)
    }
    ...
    static func headlineRounded(_ size: CGFloat = 13) -> Font {
        .system(size: size, weight: .semibold, design: .rounded)
    }
    ...
    /// Sizes, speeds, bytes — monospaced digits for alignment.
    static func metric(_ size: CGFloat = 13) -> Font {
...
struct MistPageHeader: View {
    ...
    /// Optional custom asset name. When set, the plush artwork is rendered
    /// instead of the SF Symbol tile (used for the fluffy area icons on
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 5) {
                ...
                Text(title)
                    .font(WistFont.displayRounded(22))
...
struct MistDetailCanvas<Content: View>: View {
    ...
    var body: some View {
        ZStack(alignment: .topLeading) {
            /// Dark: transparent — shell `WistShellWindowBackdrop` + glass card show through blur.
            if colorScheme == .dark {
                Color.clear
