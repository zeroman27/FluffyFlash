...
extension UUPBuilds.Build {
    ...
    /// Monotonic rank from the Windows **build string** (e.g. `26100.1742`), ignoring calendar `created`.
    /// Used to show newest builds by version label, not release date.
    var uupBuildVersionRank: Int64 {
        Self.parseBuildNumberString(build)
    }
