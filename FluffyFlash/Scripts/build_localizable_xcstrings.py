...
T: dict[str, dict[str, str]] = {
    ...
    "Browse builds": {
        "es": "Explorar compilaciones",
        "zh-Hans": "浏览版本",
        "hi": "बिल्ड ब्राउज़ करें",
        "ar": "استعراض البنيات",
        "fr": "Parcourir les builds",
        "he": "עיון בבנייה",
    },
    "Configure & cache": {
        "es": "Configurar y caché",
        "zh-Hans": "配置与缓存",
        "hi": "कॉन्फ़िगर और कैश",
        "ar": "تهيئة والتخزين المؤقت",
        "fr": "Configurer et cache",
        "he": "הגדרה ומטמון",
    },
    "Change on Source…": {
        "es": "Cambiar en Origen…",
        "zh-Hans": "在来源中更改…",
        "hi": "स्रोत पर बदलें…",
        "ar": "التغيير في المصدر…",
        "fr": "Modifier dans Source…",
        "he": "שינוי במקור…",
    },
    "Load a build on Source to see language and edition names here.": {
        "es": "Carga una compilación en Origen para ver aquí el idioma y la edición.",
        "zh-Hans": "在来源加载版本后即可在此查看语言和版本名称。",
        "hi": "भाषा और संस्करण यहाँ देखने के लिए स्रोत पर बिल्ड लोड करें।",
        "ar": "حمّل نسخة في المصدر لعرض اللغة والإصدار هنا.",
        "fr": "Chargez une build dans Source pour voir ici la langue et l’édition.",
        "he": "טען בנייה ב״מקור״ כדי לראות כאן שפה ומהדורה.",
    },
    "App language": {
        "es": "Idioma de la app",
        "zh-Hans": "应用语言",
    ...
    "Interface language for this app.": {
        "es": "Idioma de la interfaz de esta aplicación.",
        "zh-Hans": "本应用的界面语言。",
        "hi": "इस ऐप की इंटरफ़ेस भाषा।",
        "ar": "لغة واجهة هذا التطبيق.",
        "fr": "Langue de l’interface de cette application.",
        "he": "שפת הממשק של האפליקציה.",
    },
    "System default": {
    ...
    "Download UUP for a single build, or switch to Full flow for a guided path to USB.": {
        "es": "Descarga UUP para una sola compilación, o cambia a Flujo completo para una ruta guiada hasta USB.",
        "zh-Hans": "下载单个版本的 UUP，或切换到“完整流程”以引导至 USB。",
        "hi": "एक बिल्ड के लिए UUP डाउनलोड करें, या USB तक मार्गदर्शन के लिए फुल फ़्लो पर जाएँ।",
        "ar": "نزّل UUP لنسخة واحدة، أو انتقل إلى التدفق الكامل بمسار موجّه إلى USB.",
        "fr": "Téléchargez l’UUP pour une seule build, ou passez au flux complet pour un chemin guidé vers la clé USB.",
        "he": "הורידו UUP לבנייה בודדת, או עברו ל־Full flow לניווט מודרך עד USB.",
    },
}
